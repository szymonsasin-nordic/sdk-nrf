...
static bool encode_repeated_ncell_rsrq(
		zcbor_state_t *state, const struct ncell_rsrq_ *input)
{
	zcbor_print("%s\r\n", __func__);

	bool tmp_result = ((((zcbor_uint32_put(state, (4))))
	&& (((*input)._ncell_rsrq_choice == _ncell_rsrq_float32) ? ((zcbor_float32_encode(state, (&(*input)._ncell_rsrq_float32))))
	: (((*input)._ncell_rsrq_choice == _ncell_rsrq_int) ? ((zcbor_int32_encode(state, (&(*input)._ncell_rsrq_int))))
	: false))));
...
static bool encode_repeated_cell_nmr(
		zcbor_state_t *state, const struct cell_nmr_ *input)
{
	zcbor_print("%s\r\n", __func__);

	bool tmp_result = ((((zcbor_uint32_put(state, (11))))
...
static bool encode_repeated_cell_rsrq(
		zcbor_state_t *state, const struct cell_rsrq_ *input)
{
	zcbor_print("%s\r\n", __func__);

	bool tmp_result = ((((zcbor_uint32_put(state, (4))))
	&& (((*input)._cell_rsrq_choice == _cell_rsrq_float32) ? ((zcbor_float32_encode(state, (&(*input)._cell_rsrq_float32))))
	: (((*input)._cell_rsrq_choice == _cell_rsrq_int) ? ((zcbor_int32_encode(state, (&(*input)._cell_rsrq_int))))
	: false))));
		...
		zcbor_state_t *state, const struct cell *input)
{
	...
	bool tmp_result = (((zcbor_map_start_encode(state, 9) && (((((zcbor_uint32_put(state, (6))))
	...
	&& zcbor_present_encode(&((*input)._cell_nmr_present), (zcbor_encoder_t *)encode_repeated_cell_nmr, state, (&(*input)._cell_nmr))
...
static bool encode_repeated_ap_frequency(
		zcbor_state_t *state, const struct ap_frequency *input)
{
	zcbor_print("%s\r\n", __func__);
		...
		zcbor_state_t *state, const struct ap *input)
{
	...
	bool tmp_result = (((zcbor_map_start_encode(state, 6) && (((((zcbor_uint32_put(state, (12))))
	...
	&& zcbor_present_encode(&((*input)._ap_frequency_present), (zcbor_encoder_t *)encode_repeated_ap_frequency, state, (&(*input)._ap_frequency))
	&& zcbor_present_encode(&((*input)._ap_ssid_present), (zcbor_encoder_t *)encode_repeated_ap_ssid, state, (&(*input)._ap_ssid))) || (zcbor_list_map_end_force_encode(state), false)) && zcbor_map_end_encode(state, 6))));
		...
		zcbor_state_t *state, const struct wifi_ob *input)
{
	...
	bool tmp_result = (((zcbor_map_start_encode(state, 1) && (((((zcbor_uint32_put(state, (18))))
