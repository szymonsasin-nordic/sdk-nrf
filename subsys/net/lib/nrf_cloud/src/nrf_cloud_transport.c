...
{
	nct_c2g_topic_len = GW_TOPIC_STR_LEN + strlen(topic_prefix) + NRF_CLOUD_CLIENT_ID_LEN + 1;
...
void set_gw_tx_topic(char* topic_prefix)
{
	...
	nct_g2c_topic_len = GW_TOPIC_STR_LEN + strlen(topic_prefix) + NRF_CLOUD_CLIENT_ID_LEN + 1;
